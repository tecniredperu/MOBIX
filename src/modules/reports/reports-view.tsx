...
export function ReportsView({data}:{data:any}){
  ...
  return <div className="page-stack report-page">
    ...
    {data.warnings?.length>0&&<div className="report-warning-banner"><TriangleAlert size={17}/><div><strong>Reporte parcialmente disponible</strong><span>No se pudo calcular: {data.warnings.join(", ")}. El resto de la información continúa disponible.</span></div></div>}
